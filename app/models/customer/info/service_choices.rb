...
#    raise(StandardError, to_validate)
  ...
  def self.tarifs
    {
      1023 => [800, 801, 802, 805, 806, 807], #, 803, 804
      1025 => [600, 601, 602, 603, 604, 605, 610, 611, 612, 613, 622, 623, 624], #620, 621, 626
      1028 => [100, 101, 102, 103, 104, 105, 106, 107, 109, 113], #108, 112, 110
  ...
  def self.tarif_options_by_type
    {
      ...
      1028 => {
        ...
        :internet => [475, 476, 477, 478, 479, 480, 481, 482, 484, 485, 486, 487, 488, 494, 495],  
      },
      1030 => {
        :international_rouming => [288, 289, 290, 291, 292, 347],
        :country_rouming => [294, 282, 283, 321, 322, 348],  
        :mms => [323, 324, 325, 326],  
        :sms => [295, 296, 305, 306, 307, 308, 333, 334, 335, 336, 337, 338, 339, 346, 349],  
        :calls => [328, 329, 330, 331, 332, 281, 309, 293, 280],  
        :internet => [302, 303, 304, 310, 311, 313, 314, 315, 316, 317, 318, 319, 320, 342, 343, 344, 345], #, 340, 341
      },
    }
  end  
