class ServiceHelper::FinalTarifResultsPresenter
  ...
  def customer_tarif_results_array(service_set_id)
    ...
    prepared_final_tarif_results_1['tarif_results'][service_set_id].each do |service_id, prepared_tarif_result|       
    ...
    end if prepared_final_tarif_results_1 and prepared_final_tarif_results_1['tarif_results'] and prepared_final_tarif_results_1['tarif_results'][service_set_id]
...
#    result.sort_by!{|item| item['service_set_price']}    
  ...
  def customer_tarif_detail_results_array(service_set_id, service_id)
    result = []
    prepared_final_tarif_results_1 = prepared_final_tarif_results
    prepared_final_tarif_results_1['tarif_detail_results'][service_set_id][service_id].each do |service_category_name, prepared_tarif_detail_result|       
    ...
    end if prepared_final_tarif_results_1 and prepared_final_tarif_results_1['tarif_detail_results'] and  
             prepared_final_tarif_results_1['tarif_detail_results'][service_set_id] and prepared_final_tarif_results_1['tarif_detail_results'][service_set_id][service_id]
    result = result.compact
#    result.sort_by!{|item| item['service_set_price']}    
  end
