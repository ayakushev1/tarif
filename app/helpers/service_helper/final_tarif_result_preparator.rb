class ServiceHelper::FinalTarifResultPreparator
  ...
  def self.prepare_final_tarif_results_by_tarif(input_data)
    ...
    prepared_final_tarif_results ||= {'service_set' => {}, 'tarif_results' => {}, 'tarif_detail_results' => {}}
    final_tarif_sets.each do |service_set_id, final_tarif_set|
      ...
      prepared_final_tarif_results[service_set_id] ||= {'service_set_price' => 0.0, 'service_set_count' => 0, 'tarif' => tarif, 'operator' => operator}
