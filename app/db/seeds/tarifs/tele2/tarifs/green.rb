...
#Own and home regions, calls, outcoming, to sic_1, в Узбекистан и Таджикистан 
  ...
  :filtr => {:to_abroad_countries => {:in => Category::Country::Tel::Service_to_sic_1 }}}
...
#Own and home regions, calls, outcoming, to sic_2, в Азербайджан, Беларусь и Молдову
  ...
  :filtr => {:to_abroad_countries => {:in => Category::Country::Tel::Service_to_sic_2 }}}
...
#Own and home regions, calls, outcoming, to sic_3, в остальные страны СНГ
  ...
  :filtr => {:to_abroad_countries => {:in => Category::Country::Tel::Service_to_sic_3 }}}
...
#Own and home regions, calls, outcoming, to Europe
  ...
  :filtr => {:to_abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_2 }}}
...
#Own and home regions, calls, outcoming, to USA and Canada
  ...
  :filtr => {:to_abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_3 }}}
...
#Own and home regionsIC, calls, outcoming, to other countries
  ...
  :filtr => {:to_abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_4 }}}
...
#Own and home regions, sms, outcoming
  category = {:name => '_sctcg_own_home_regions_sms_outcoming', :service_category_rouming_id => _own_and_home_regions_rouming, :service_category_calls_id => _sms_out, :service_category_geo_id => _service_to_own_and_home_regions}
  ...
  category = {:name => '_sctcg_own_home_regions_sms_outcoming', :service_category_rouming_id => _own_and_home_regions_rouming, :service_category_calls_id => _sms_out, :service_category_geo_id => _service_to_own_country}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceByCountVolumeItem, :formula => {:params => {:price => 3.4} } })  
