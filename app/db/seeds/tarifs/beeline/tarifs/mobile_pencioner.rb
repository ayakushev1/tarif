...
category = {:name => '_sctcg_own_region_calls_to_own_and_home_regions', :service_category_rouming_id => _own_region_rouming, :service_category_calls_id => _calls_out, 
...
category = {:name => '_sctcg_home_region_calls_to_own_and_home_regions', :service_category_rouming_id => _home_region_rouming, :service_category_calls_id => _calls_out, 
