...
#    @customer_service_sets = 
    @customer_service_sets ||= create_array_of_hashable(final_tarif_results_presenter.
  ...
  def customer_tarif_results        
    ...
    result = create_array_of_hashable(final_tarif_results_presenter.customer_tarif_results_array(customer_service_set_tarif_id, service_sets_id), options)
#    raise(StandardError)
  end
  ...
  def customer_tarif_detail_results
    ...
    create_array_of_hashable(final_tarif_results_presenter.customer_tarif_detail_results_array(
      customer_service_set_tarif_id, service_sets_id, session[:current_id]['service_id']), options)
  end
