...
class Customer::AdminTarifOptimizatorsController < ApplicationController
  include Customer::AdminTarifOptimizatorHelper, Customer::TarifOptimizatorBackgroundHelper
