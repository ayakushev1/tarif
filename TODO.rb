...
#TODO что делать с опциями от которых зависят если цена и звонки равны нулю
#TODO Разобраться с Мегафоном(проблема частично в ммс и опции путешествий по центральному региону)
# (и с остальными) - какие опции несовместимы. И почему у Мегафона так много вариантов
#TODO Определиться когда использовать платежи за подключение опций и тарифов и внести изменения
#TODO Определиться когда считать опции с лимитами (пока сделал все опции безлимитными)
#TODO Добавить многомесячный расчет (во время парсинга объединяешь результаты)    
#TODO выбор двух тарифов
