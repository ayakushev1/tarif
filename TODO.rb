...
#TODO Увеличить количество страниц для тарифов (для отдельных операторов и регионов)
#TODO Добавить раздел Новости
#TODO Добавить раздел Статьи (полезные советы)
#TODO Добавить раздел Часто задаваемые вопросы
#TODO Добавить форму обратной связи и контакты для связи
#TODO Добавить форму поиска по сайту
#TODO Добавить инструкцию пользования сайтам в разделе Сервисы сайта
#TODO Добавить контакты в формате Schema.org
#TODO 
#TODO 
#TODO 
#TODO 
