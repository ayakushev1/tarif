#TODO Добавить опросник после запуска подбора тарифа
...
#TODO Добавить вторую звездочку в новых лендингах
#TODO Добавить поиск (по тарифам)
#TODO Сброс фильторов (тарифы)
#TODO поменять горизонтальное меню
#TODO добавить количество страниц по тарифам
#TODO
...
#TODO Добавить описание корзины в упрощенные рейтинги
