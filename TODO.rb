...
#TODO Зарегистрировать сайт в поисковиках
#TODO Добавить yandex-money и соответствующий work-flow 
#TODO Переделать подход к подбору тарифов с помощью delayed_jobs
#TODO Переделать и перетестировать систему авторизации и демо=сайта
#TODO 
    
#TODO Глобальные задач
#TODO добавить анализ чувствительности (исходя из известных ключевых точках тарифов)

#TODO что делать с опциями от наличия которых зависят в случае, если цена и звонки равны нулю
