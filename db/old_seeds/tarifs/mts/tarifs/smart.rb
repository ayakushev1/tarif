...
#Добавление новых service_category_group
  ...
  scg_mts_smart_included_in_tarif_calls = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_price_by_sum_duration_minute, :formula => {:window_condition => "(400.0 >= sum_duration_minute)"}, :price => 0.0, :description => '' }
    )
  ...
  scg_mts_smart_included_in_tarif_internet = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_sum_volume_m_byte, :formula => {:window_condition => "(1500.0 >= sum_volume)"}, :price => 0.0, :description => '' }
    )
...
#Own region, Calls, Outcoming, to_local_number, to_own_operator
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_region_calls_local_own_operator, scg_mts_smart_included_in_tarif_calls[:id])
...
#Own region, Calls, Outcoming, to_local_number, to_other_operator
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_region_calls_local_other_operator, scg_mts_smart_included_in_tarif_calls[:id])
...
#Own region, Calls, Outcoming, to_local_number, to_fixed_line
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_region_calls_local_fixed_line, scg_mts_smart_included_in_tarif_calls[:id])
...
#Own region, sms, Outcoming, to_local_number
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_region_sms_local, scg_mts_smart_included_in_tarif_sms[:id])
...
#Own region, Internet
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_region_internet, scg_mts_smart_included_in_tarif_internet[:id])
...
#  @tc.add_as_other_service_category_tarif_class(_sctcg_own_country_internet, _sctcg_own_region_internet)
