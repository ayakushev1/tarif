...
@tc.create_tarif_class({
  ...
  :features => {:http => 'http://moscow.megafon.ru/tariffs/alltariffs/all_inclusive/all_inclusive_l/l.html'},
  :dependency => {
    :incompatibility => {},
...
#Добавление новых service_category_group
  ...
  scg_mgf_all_included_l_calls = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_price_by_sum_duration_minute, 
      :formula => {:window_condition => "(800.0 >= sum_duration_minute)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
  ...
  scg_mgf_all_included_l_sms = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_count_volume_item, 
      :formula => {:window_condition => "(800 >= count_volume)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
...
#    {:calculation_order => 0, :standard_formula_id => _stf_zero_count_volume_item, 
#      :formula => {:window_condition => "(1800 >= count_volume)", :window_over => 'month'}, :price => 0.0, :description => '' }
#    )
  ...
  scg_mgf_all_included_l_internet = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_sum_volume_m_byte, 
      :formula => {:window_condition => "(8000.0 >= sum_volume)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
  ...
  scg_mgf_add_speed_1gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 1, :price => 150.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mgf_add_speed_1gb_mgf_all_included_l', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
  ...
  scg_mgf_add_speed_5gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 2, :price => 400.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mgf_add_speed_5gb_mgf_all_included_l', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => _stf_price_by_1_month, :price => 1300.0})
...
category = {:name => '_sctcg_own_country_calls_to_own_operator_own_operator', :service_category_rouming_id => _own_country_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _service_to_own_country, :service_category_partner_type_id => _service_to_own_operator}
  @tc.add_grouped_service_category_tarif_class(category, scg_mgf_all_included_l_calls[:id])
