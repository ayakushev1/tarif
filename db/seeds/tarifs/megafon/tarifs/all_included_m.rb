...
#Добавление новых service_category_group
  ...
  scg_mgf_all_included_m_sms_mms = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_count_volume_item, 
      :formula => {:window_condition => "(400 >= count_volume)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
  ...
  scg_mgf_all_included_m_internet = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_sum_volume_m_byte, 
      :formula => {:window_condition => "(5000.0 >= sum_volume)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
  ...
  scg_mgf_add_speed_1gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 1, :price => 150.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mgf_add_speed_1gb_mgf_all_included_m', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
  ...
  scg_mgf_add_speed_5gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 2, :price => 400.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mgf_add_speed_5gb_mgf_all_included_m', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => _stf_price_by_1_month, :price => 700.0})
