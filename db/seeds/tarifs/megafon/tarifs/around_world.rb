...
category = {:name => '_sctcg_own_home_regions_calls_to_own_home_regions', :service_category_rouming_id => _own_and_home_regions_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _service_to_own_and_home_regions}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 1.8})
...
category = {:name => '_sctcg_around_world_1_calls_to_own_country', :service_category_rouming_id => _sc_mgf_around_world_countries_1, :service_category_calls_id => _calls_out, :service_category_geo_id => _service_to_own_country}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 13.0})
...
category = {:name => '_sctcg_around_world_2_calls_to_own_country', :service_category_rouming_id => _sc_mgf_around_world_countries_2, :service_category_calls_id => _calls_out, :service_category_geo_id => _service_to_own_country}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 13.0})
...
category = {:name => '_sctcg_around_world_2_sms_outcoming', :service_category_rouming_id => _sc_mgf_around_world_countries_2, :service_category_calls_id => _sms_out}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_count_volume_item, :price => 11.0})
...
category = {:name => '_sctcg_around_world_3_calls_to_own_country', :service_category_rouming_id => _sc_mgf_around_world_countries_3, :service_category_calls_id => _calls_out, :service_category_geo_id => _service_to_own_country}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 19.0})
...
category = {:name => '_sctcg_around_world_3_sms_outcoming', :service_category_rouming_id => _sc_mgf_around_world_countries_3, :service_category_calls_id => _sms_out}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_count_volume_item, :price => 14.0})
...
category = {:name => '_sctcg_around_world_4_calls_incoming', :service_category_rouming_id => _sc_mgf_around_world_countries_4, :service_category_calls_id => _calls_in}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 43.0})

#Around_world_4, Calls, Outcoming, to_own_country
category = {:name => '_sctcg_around_world_4_calls_to_own_country', :service_category_rouming_id => _sc_mgf_around_world_countries_4, :service_category_calls_id => _calls_out, :service_category_geo_id => _service_to_own_country}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 43.0})
...
#Around_world_5, Internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_volume_m_byte, :price => 19.0})
