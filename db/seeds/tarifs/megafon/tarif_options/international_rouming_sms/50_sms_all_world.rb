...
@tc.create_tarif_class({
  :id => _mgf_50_sms_all_world, :name => '50 SMS Весь мир', :operator_id => _megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
#Not Russia, sms, Outcoming
  @tc.add_one_service_category_tarif_class(_sctcg_not_russia_rouming_sms_outcoming, {}, 
    {:calculation_order => 0, :price => 495.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _item, :description => '', 
     :formula => {
