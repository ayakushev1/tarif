...
@tc.create_tarif_class({
  :id => _mgf_internet_s, :name => 'Интернет S', :operator_id => _megafon, :privacy_id => _person, :standard_service_id => _special_service,
     ...
     :formula => {
       ...
       :auto_turbo_buttons  => {
         ...
         :stat_params => {
           ...
           :count_of_usage_of_1000 => "ceil((sum((description->>'volume')::float) - 3000.0) / 1000.0)",
           :count_of_usage_of_2500 => "ceil((sum((description->>'volume')::float) - 3000.0) / 2500.0)"},
