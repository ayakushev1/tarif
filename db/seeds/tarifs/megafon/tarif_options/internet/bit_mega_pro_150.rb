...
@tc.create_tarif_class({
  :id => _mgf_bit_mega_pro_150, :name => 'БИТ MegaPRO 150', :operator_id => _megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
scg_mgf_bit_mega_pro_150 = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :price => 14.9, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'stf_mgf_bit_mega_pro_150', :description => '', 
     :formula => {
       :window_condition => "(150.0 >= sum_volume)", :window_over => 'day',
