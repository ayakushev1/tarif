...
@tc.create_tarif_class({
  ...
  :dependency => {
    :incompatibility => {
      ...
      :international_calls_options_with_25_discount => [_mgf_25_discount_on_calls_to_russia_and_all_incoming, _mgf_all_world, _mgf_30_minutes_all_world, _mgf_far_countries, _mgf_option_around_world, _mgf_100_minutes_europe]}, 
