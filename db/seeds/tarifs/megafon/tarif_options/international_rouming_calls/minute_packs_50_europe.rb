...
@tc.create_tarif_class({
  :id => _mgf_minute_packs_50_europe, :name => 'Пакеты минут 50 Европа и СНГ', :operator_id => _megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
scg_minute_packs_50_europe = @tc.add_service_category_group(
  ...
  {:calculation_order => 0, :price => 529.0, :price_unit_id => _rur, :volume_id => _call_description_duration, :volume_unit_id => _minute, :name => '_stf_minute_packs_25_europe', :description => '', 
   :formula => {
     :window_condition => "(50.0 >= sum_duration_minute)", :window_over => 'month',
