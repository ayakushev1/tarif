...
@tc.create_tarif_class({
  :id => _mgf_option_for_sms_m, :name => 'Опция для SMS M', :operator_id => _megafon, :privacy_id => _person, :standard_service_id => _special_service,
...
#Подключение услуги
  @tc.add_one_service_category_tarif_class(_sctcg_one_time_tarif_switch_on, {}, {:standard_formula_id => _stf_price_by_1_item, :price => 245.0})
...
category = {:name => '_sctcg_own_country_sms_to_own_and_home_regions', :service_category_rouming_id => _own_country_rouming, :service_category_calls_id => _sms_out, :service_category_geo_id => _service_to_own_and_home_regions}
