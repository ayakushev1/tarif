...
@tc.create_tarif_class({
  ...
  :dependency => {
    :incompatibility => {:options_for_sms => [_mgf_option_for_sms_s, _mgf_option_for_sms_l, _mgf_option_for_sms_m, _mgf_option_for_sms_xl]}, 
...
category = {:name => '_sctcg_own_home_regions_sms_to_own_and_home_regions', :service_category_rouming_id => _own_and_home_regions_rouming, :service_category_calls_id => _sms_out, :service_category_geo_id => _service_to_own_and_home_regions}
  @tc.add_one_service_category_tarif_class(category, {},
    {:calculation_order => 0, :price => 245.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _item, :description => '', 
     :formula => {
       :window_condition => "(300 >= count_volume)", :window_over => 'month',
