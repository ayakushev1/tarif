...
@tc.create_tarif_class({
  :id => _bln_all_for_900, :name => 'Всё за 900', :operator_id => _beeline, :privacy_id => _person, :standard_service_id => _tarif,
...
#Добавление новых service_category_group
  ...
  scg_bln_all_for_900_sms = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_count_volume_item, 
      :formula => {:window_condition => "(150 >= count_volume)", :window_over => 'day'}, :price => 0.0, :description => '' }
    )
