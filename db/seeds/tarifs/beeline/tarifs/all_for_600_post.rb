...
@tc.create_tarif_class({
  :id => _bln_all_for_600_post, :name => 'Всё за 600 (постоплатный)', :operator_id => _beeline, :privacy_id => _person, :standard_service_id => _tarif,
...
#Добавление новых service_category_group
  ...
  scg_bln_all_for_600_post_calls = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_price_by_sum_duration_minute, 
      :formula => {:window_condition => "(350.0 >= sum_duration_minute)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
  ...
  scg_bln_all_for_600_post_internet = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_sum_volume_m_byte, 
      :formula => {:window_condition => "(6000.0 >= sum_volume)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
