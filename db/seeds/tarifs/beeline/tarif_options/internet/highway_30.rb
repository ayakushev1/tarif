...
@tc.create_tarif_class({
  :id => _bln_highway_30, :name => 'Хайвей 30 Гб', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {:http => 'http://moskva.beeline.ru/customers/products/mobile/services/details/highway-30gb/'},
  :dependency => {
...
scg_bln_highway_30 = @tc.add_service_category_group(
    {:name => 'scg_bln_highway_30' }, 
    {:name => "price for scg_bln_highway_30"}, 
    {:calculation_order => 0, :price => 1150.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'stf_bln_highway_30', :description => '', 
     :formula => {
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_highway_30[:id])
