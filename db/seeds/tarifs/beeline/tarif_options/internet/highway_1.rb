...
@tc.create_tarif_class({
  :id => _bln_highway_1, :name => 'Хайвей 1 Гб', :operator_id => _beeline, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {:http => 'http://moskva.beeline.ru/customers/products/mobile/services/details/highway-1gb-nedelya-besplatno/'},
  :dependency => {
...
scg_bln_highway_1 = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :price => 7.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'stf_bln_highway_1', :description => '', 
     :formula => {
       :window_condition => "(1000.0 >= sum_volume)", :window_over => 'day',
       ...
       :auto_turbo_buttons  => {
         ...
         :stat_params => {
           ...
           :count_of_usage_of_200 => "ceil((sum((description->>'volume')::float) - 1000.0) / 200.0)"},
