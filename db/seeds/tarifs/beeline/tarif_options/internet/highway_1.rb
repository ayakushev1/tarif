     ...
     :formula => {
       ...
       :auto_turbo_buttons  => {
         ...
         :stat_params => {
           ...
           :count_of_usage_of_3000 => "ceil((sum((description->>'volume')::float) - 1000.0) / 3000.0)"},
...
#_sc_rouming_bln_exept_for_cenral_regions_not_moscow_regions, Internet
  category = {:name => '_sc_rouming_bln_exept_for_cenral_regions_not_moscow_regions_internet', :service_category_rouming_id => _sc_rouming_bln_exept_for_cenral_regions_not_moscow_regions, :service_category_calls_id => _internet}
