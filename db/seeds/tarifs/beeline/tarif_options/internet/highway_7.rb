...
scg_bln_highway_7 = @tc.add_service_category_group(
    {:name => 'scg_bln_highway_7' }, 
    {:name => "price for scg_bln_highway_7"}, 
    {:calculation_order => 0, :price => 550.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'stf_bln_highway_7', :description => '', 
     :formula => {
       ...
       :auto_turbo_buttons  => {
         ...
         :stat_params => {
           ...
           :count_of_usage_of_200 => "ceil((sum((description->>'volume')::float) - 7000.0) / 200.0)"},
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_bln_highway_7[:id])
