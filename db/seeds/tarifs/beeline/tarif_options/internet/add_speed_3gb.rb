...
@tc.create_tarif_class({
  :id => _bln_add_speed_3gb, :name => 'Продли скорость 3 Гб', :operator_id => Category::Operator::Const::Beeline, :privacy_id => _person, :standard_service_id => _special_service,
  :features => {:http => 'http://moskva.beeline.ru/customers/products/mobile/services/details/prodli-skorost-3-gb/'},
  :dependency => {
