...
@tc.create_tarif_class({
  ...
  :features => {:http => 'http://msk.tele2.ru/tariff/ultrablack/', :buy_http => 'http://msk.shop.tele2.ru/products/choose_tariff/_gv/tariff-id_12182'},
  :dependency => {
    :incompatibility => {},
...
#Добавление новых service_category_group
  ...
  scg_tele_add_speed_100mb = @tc.add_service_category_group(
    {:name => 'scg_tele_add_speed_100mb_tele_mostest_black' }, 
    {:name => "price for scg_tele_add_speed_100mb_tele_mostest_black"}, 
  ...
  scg_tele_add_speed_3gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_speed_3gb_tele_mostest_black' }, 
    {:name => "price for scg_tele_add_speed_3gb_tele_mostest_black"}, 
...
#Own and home regions, Internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 3,:standard_formula_id => Price::StandardFormula::Const::PriceBySumVolumeMByte, :formula => {:params => {:price => 0.16} } })  #как в опции Добавить скорость плюс 1 копейка
