...
@tc.create_tarif_class({
  :id => _tele_orange, :name => 'Оранжевый', :operator_id => _tele_2, :privacy_id => _person, :standard_service_id => _tarif,
  :features => {:http => 'http://msk.tele2.ru/tariff/orange/'},
  :dependency => {
    :incompatibility => {},
...
category = {:name => '_sctcg_own_home_regions_calls_to_own_home_regions_not_own_operator', :service_category_rouming_id => _own_and_home_regions_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _service_to_own_and_home_regions, :service_category_partner_type_id => _service_to_not_own_operator}
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 1.00})
...
#Own and home regions, Internet
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_volume_m_byte, :price => 1.0})  
