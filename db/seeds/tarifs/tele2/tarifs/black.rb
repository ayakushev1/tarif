...
@tc.create_tarif_class({
  ...
  :features => {:http => 'http://msk.tele2.ru/tariff/black/', :buy_http => 'http://msk.shop.tele2.ru/products/choose_tariff/_gv/tariff-id_10659'},
  :dependency => {
    :incompatibility => {},
...
#Добавление новых service_category_group
  ...
  scg_tele_add_speed_100mb = @tc.add_service_category_group(
    {:name => 'scg_tele_add_speed_100mb_tele_black' }, 
    {:name => "price for scg_tele_add_speed_100mb_tele_black"}, 
  ...
  scg_tele_add_speed_3gb= @tc.add_service_category_group(
    {:name => 'scg_tele_add_speed_3gb_tele_black' }, 
    {:name => "price for scg_tele_add_speed_3gb_tele_black"}, 
