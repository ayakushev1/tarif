...
#Добавление новых service_category_group
  ...
  scg_tele_add_speed_100mb = @tc.add_service_category_group(
    ...
    {:calculation_order => 1, :price => 15.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_tele_add_speed_100mb_tele_black', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'day',
         :stat_params => {
  ...
  scg_tele_add_speed_3gb= @tc.add_service_category_group(
    ...
    {:calculation_order => 2, :price => 150.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_tele_add_speed_3gb_tele_black', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
