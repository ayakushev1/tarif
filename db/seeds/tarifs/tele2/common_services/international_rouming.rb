...
#SIC, calls, outcoming, to sic
  category = {:name => '_sctcg_SIC_calls_to_sic', :service_category_rouming_id => _sc_tele_sic_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_1, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_1 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_1 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 15.0} } })  

#SIC, calls, outcoming, to Europe
  category = {:name => '_sctcg_SIC_calls_to_europe', :service_category_rouming_id => _sc_tele_sic_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_2, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_1 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_2 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 15.0} } })  

#SIC, calls, outcoming, to Asia, Africa, Australia
  category = {:name => '_sctcg_SIC_calls_to_asia_afr_austr', :service_category_rouming_id => _sc_tele_sic_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_5, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_1 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_5 }}}
...
#SIC, calls, outcoming, to Noth and South America
  category = {:name => '_sctcg_SIC_calls_to_americas', :service_category_rouming_id => _sc_tele_sic_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_6, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_1 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_6 }}}
...
#Europe, calls, outcoming, to sic
  category = {:name => '_sctcg_europe_calls_to_sic', :service_category_rouming_id => _sc_tele_europe_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_1, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_2 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_1 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 15.0} } })  

#Europe, calls, outcoming, to Europe
  category = {:name => '_sctcg_europe_calls_to_europe', :service_category_rouming_id => _sc_tele_europe_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_2, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_2 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_2 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 15.0} } })  

#Europe, calls, outcoming, to Asia, Africa, Australia
  category = {:name => '_sctcg_europe_calls_to_asia_afr_austr', :service_category_rouming_id => _sc_tele_europe_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_5, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_2 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_5 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 35.0} } })  

#Europe, calls, outcoming, to Noth and South America
  category = {:name => '_sctcg_europe_calls_to_americas', :service_category_rouming_id => _sc_tele_europe_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_6, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_2 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_6 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 65.0} } })  
...
#Asia, Africa and Australia, calls, outcoming, to sic
  category = {:name => '_sctcg_asia_afr_aust_calls_to_sic', :service_category_rouming_id => _sc_tele_asia_afr_aust_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_1, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_5 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_1 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 35.0} } })  

#Asia, Africa and Australia, calls, outcoming, to Europe
  category = {:name => '_sctcg_asia_afr_aust_calls_to_europe', :service_category_rouming_id => _sc_tele_asia_afr_aust_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_2, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_5 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_2 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 35.0} } })  

#Asia, Africa and Australia, calls, outcoming, to Asia, Africa, Australia
  category = {:name => '_sctcg_asia_afr_aust_calls_to_asia_afr_austr', :service_category_rouming_id => _sc_tele_asia_afr_aust_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_5, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_5 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_5 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 35.0} } })  

#Asia, Africa and Australia, calls, outcoming, to Noth and South America
  category = {:name => '_sctcg_asia_afr_aust_calls_to_americas', :service_category_rouming_id => _sc_tele_asia_afr_aust_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_6, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_5 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_6 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 65.0} } })  
...
#South and North America, calls, outcoming, to sic
  category = {:name => '_sctcg_americas_calls_to_sic', :service_category_rouming_id => _sc_tele_americas_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_1, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_6 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_1 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 65.0} } })  

#South and North America, calls, outcoming, to Europe
  category = {:name => '_sctcg_americas_calls_to_europe', :service_category_rouming_id => _sc_tele_americas_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_2, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_6 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_2 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 65.0} } })  

#South and North America, calls, outcoming, to Asia, Africa, Australia
  category = {:name => '_sctcg_americas_calls_to_asia_afr_austr', :service_category_rouming_id => _sc_tele_americas_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_5, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_6 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_5 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 65.0} } })  

#South and North America, calls, outcoming, to Noth and South America
  category = {:name => '_sctcg_americas_calls_to_americas', :service_category_rouming_id => _sc_tele_americas_rouming, :service_category_calls_id => _calls_out, :service_category_geo_id => _sc_service_to_tele_from_abroad_to_international_6, 
  :filtr => {:abroad_countries => {:in => Category::Country::Tel::Service_to_tele_international_6 }, :to_other_countries => {:in => Category::Country::Tel::Service_to_tele_international_6 }}}
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => Price::StandardFormula::Const::PriceBySumDuration, :formula => {:params => {:price => 65.0} } })  
