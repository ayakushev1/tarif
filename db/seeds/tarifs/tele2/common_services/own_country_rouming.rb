...
#Own country region group 1, sms, outcoming, to all own country regions, to all operators
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_count_volume_item, :price => 3.5})  
...
#Own country region group 1, sms, outcoming, to not own country
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_count_volume_item, :price => 5.5})  
...
#Own country region group 2, calls, incoming
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 5.00})  
...
#Own country region group 2, sms, outcoming, to all own country regions, to all operators
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_count_volume_item, :price => 3.50})  
...
#Own country region group 2, sms, outcoming, to not own country
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_count_volume_item, :price => 5.50})  
