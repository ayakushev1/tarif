...
@tc.create_tarif_class({
  ...
  :features => {:http => 'http://spb.tele2.ru/roaming/russia/'},
  :dependency => {
...
#Own country region group 1, calls, outcoming, to sic
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 40.0})  
...
#Own country region group 1, calls, outcoming, to Europe
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 90.0})  
...
#Own country region group 2, calls, incoming
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 0.00})  
...
#Own country region group 2, calls, outcoming, to all own country regions, to own operator
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 1.50})  
...
#Own country region group 2, sms, outcoming, to all own country regions, to all operators
  ...
  @tc.add_one_service_category_tarif_class(category, {}, {:standard_formula_id => _stf_price_by_count_volume_item, :price => 1.50})  
