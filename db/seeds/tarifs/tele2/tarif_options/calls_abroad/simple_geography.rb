...
#Own and home regions, calls, outcoming, to _sc_tele_service_to_uzbekistan
  ...
  :filtr => {:to_abroad_countries => {:in => Category::Country::Tel::Service_to_uzbekistan }}}
...
#Own and home regions, calls, outcoming, to _sc_tele_service_to_sic_not_uzbekistan
  ...
  :filtr => {:to_abroad_countries => {:in => Category::Country::Tel::Service_to_sic_not_uzbekistan }}}
