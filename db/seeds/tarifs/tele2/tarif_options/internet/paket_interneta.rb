...
@tc.create_tarif_class({
  ...
  :features => {:http => 'http://spb.tele2.ru/internet/skidki/paket-interneta/'},
  :dependency => {
    :incompatibility => {
...
scg_tele_paket_interneta = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :price => 250.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'stf_tele_paket_interneta', :description => '', 
     :formula => {
