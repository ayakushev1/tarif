...
#bit_abrod_1 rouming, internet
  @tc.add_one_service_category_tarif_class(_sctcg_bit_abrod_1_rouming_internet, {}, 
    {:calculation_order => 0, :price => 1000.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => '_stf_bit_abrod_1_rouming_internet', :description => '', 
     :formula => {
       :window_condition => "(25.0 >= sum_volume)", :window_over => 'day',
       :stat_params => {:sum_volume => "sum((description->>'volume')::float)"},
       :method => "case when sum_volume > 0.0 then price_formulas.price else 0.0 end",
       
       :multiple_use_of_tarif_option => {
         :group_by => 'day',
         :stat_params => {:tarif_option_count_of_usage => "ceil(sum((description->>'volume')::float) / 25.0)"},
...
#bit_abrod_2 rouming, internet
  @tc.add_one_service_category_tarif_class(_sctcg_bit_abrod_2_rouming_internet, {}, 
    {:calculation_order => 0, :price => 1000.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => '_stf_bit_abrod_2_rouming_internet', :description => '', 
     :formula => {
...
#bit_abrod_3 rouming, internet
  @tc.add_one_service_category_tarif_class(_sctcg_bit_abrod_3_rouming_internet, {}, 
    {:calculation_order => 0, :price => 1000.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => '_stf_bit_abrod_3_rouming_internet', :description => '', 
     :formula => {
       ...
       :multiple_use_of_tarif_option => {
         :group_by => 'day',
         :stat_params => {:tarif_option_count_of_usage => "ceil(sum((description->>'volume')::float) / 250.0)"},
         :method => "price_formulas.price * tarif_option_count_of_usage" } } } )

#bit_abrod_4 rouming, internet
  @tc.add_one_service_category_tarif_class(_sctcg_bit_abrod_4_rouming_internet, {}, 
    {:calculation_order => 0, :price => 10000.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => '_stf_bit_abrod_4_rouming_internet', :description => '', 
     :formula => {
