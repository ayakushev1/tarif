...
@tc.create_tarif_class({
  :id => _mts_everywhere_as_home_Ultra, :name => 'Везде как дома ULTRA', :operator_id => _mts, :privacy_id => _person, :standard_service_id => _special_service,
...
_sctcg_own_country_calls_incoming = {:name => '_sctcg_own_country_calls_incoming', :service_category_rouming_id => _own_country_rouming, :service_category_calls_id => _calls_in}
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => _stf_price_by_1_month_if_used, :price => 400.0})
 
#Own country, Calls, incoming
  @tc.add_one_service_category_tarif_class(_sctcg_own_country_calls_incoming, {}, 
