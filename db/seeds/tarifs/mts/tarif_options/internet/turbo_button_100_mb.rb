...
scg_mts_turbo_button_100_mb_for_smart = @tc.add_service_category_group(
    {:name => 'scg_mts_turbo_button_100_mb_for_smart' }, 
    {:name => "price for scg_mts_turbo_button_100_mb_for_smart"}, 
    {:calculation_order => 0, :price => 30.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'stf_mts_turbo_button_100_mb_for_smart', :description => '', 
     :formula => {
...
#Own and home regions, Internet
  ...
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_turbo_button_100_mb_for_smart[:id])
