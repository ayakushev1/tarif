...
@tc.create_tarif_class({
  :id => _mts_additional_internet_smart_other, :name => 'Дополнительный пакет интернета Smart Nonstop, Plus, Top', :operator_id => _mts, :privacy_id => _person, :standard_service_id => _special_service,
