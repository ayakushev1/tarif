...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => _stf_price_by_1_month_if_used, :price => 950.0})
...
#Home region, internet
  @tc.add_one_service_category_tarif_class(_sctcg_home_region_internet, {}, 
    {:calculation_order => 0,:standard_formula_id => _stf_zero_sum_volume_m_byte, :price => 0.0,
     :formula => {:window_condition => "(20000.0 < sum_volume)", :window_over => 'month'} } )
