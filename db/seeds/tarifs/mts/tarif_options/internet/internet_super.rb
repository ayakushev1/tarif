...
@tc.create_tarif_class({
  ...
  :dependency => {
    ...
    :prerequisites => [],
    :forbidden_tarifs => {:to_switch_on => [_mts_smart, _mts_smart_mini, _mts_smart_plus, _mts_ultra, _mts_smart_nonstop, _mts_mts_connect_4, _mts_smart_top], :to_serve => []},
    :multiple_use => false
  } } )
  ...
  scg_mts_internet_super_included_in_tarif_internet = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :price => 950.0, :description => '', 
      :formula => {
...
#auto_turbo_buttons 
  ...
  scg_mts_add_speed_500mb = @tc.add_service_category_group(
    ...
    {:calculation_order => 1, :price => 95.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_500mb_mts_internet_super', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
  ...
  scg_mts_add_speed_2gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 2, :price => 250.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_2gb_mts_internet_super', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
  ...
  scg_mts_add_speed_5gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 3, :price => 450.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_5gb_mts_internet_super', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
