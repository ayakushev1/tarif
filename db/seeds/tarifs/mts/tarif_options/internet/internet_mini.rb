...
@tc.create_tarif_class({
  ...
  scg_mts_internet_mini_included_in_tarif_internet = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :price => 350.0, :name => 'scf_mts_internet_mini_included_in_tarif_internet', :description => '', 
      :formula => {
...
#auto_turbo_buttons 
  ...
  scg_mts_add_speed_500mb = @tc.add_service_category_group(
    ...
    {:calculation_order => 1, :price => 95.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_500mb_mts_internet_mini', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
  ...
  scg_mts_add_speed_2gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 2, :price => 250.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_2gb_mts_internet_mini', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
  ...
  scg_mts_add_speed_5gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 3, :price => 450.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_5gb_mts_internet_mini', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
