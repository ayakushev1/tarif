...
@tc.create_tarif_class({
  :id => _mts_love_country, :name => 'Любимая страна', :operator_id => _mts, :privacy_id => _person, :standard_service_id => _special_service,
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => _stf_price_by_1_month_if_used, :price => 70.0})
