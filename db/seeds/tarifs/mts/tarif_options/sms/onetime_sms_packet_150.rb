...
@tc.create_tarif_class({
  :id => _mts_onetime_sms_packet_150, :name => 'SMS пакет 150', :operator_id => _mts, :privacy_id => _person, :standard_service_id => _special_service,
  ...
  :dependency => {
    ...
    :prerequisites => [],
    :forbidden_tarifs => {:to_switch_on => [_mts_ultra, _mts_red_energy], :to_serve => []},
    :multiple_use => true
  } } )
...
#Own and home regions, sms, outcoming, to own and home regions
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :price => 200.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _item, :description => '', 
     :formula => {
       :window_condition => "(150.0 >= count_volume)", :window_over => 'month',
       ...
       :multiple_use_of_tarif_option => {
         :group_by => 'month',
         :stat_params => {:tarif_option_count_of_usage => "ceil(count(description->>'volume') / 150.0)", :count_volume => "count(description->>'volume')"},
