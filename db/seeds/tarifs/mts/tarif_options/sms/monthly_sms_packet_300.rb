...
@tc.create_tarif_class({
  :id => _mts_monthly_sms_packet_300, :name => 'Пакет 300 SMS', :operator_id => _mts, :privacy_id => _person, :standard_service_id => _special_service,
...
#Own and home regions, sms, outcoming, to own and home regions
  @tc.add_one_service_category_tarif_class(category, {}, 
    {:calculation_order => 0, :price => 210.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _item, :description => '', 
     :formula => {
       :window_condition => "(300.0 >= count_volume)", :window_over => 'month',
