...
@tc.create_tarif_class({
  :id => _mts_100_sms_in_europe, :name => '100 SMS в Европе', :operator_id => _mts, :privacy_id => _person, :standard_service_id => _special_service,
  :dependency => {
...
#Own country, sms, Outcoming
  @tc.add_one_service_category_tarif_class(_sctcg_mts_europe_rouming_sms_outcoming, {}, 
    {:calculation_order => 0, :price => 350.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _item, :description => '', 
     :formula => {
       ...
       :multiple_use_of_tarif_option => {
         :group_by => 'month',
         :stat_params => {:tarif_option_count_of_usage => "ceil(count((description->>'volume')::integer) / 100)"},
