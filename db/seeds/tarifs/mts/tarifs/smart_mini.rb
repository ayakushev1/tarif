...
@tc.create_tarif_class({
  :id => _mts_smart_mini, :name => 'Smart mini', :operator_id => _mts, :privacy_id => _person, :standard_service_id => _tarif,
  :dependency => {
...
#Own and home regions, sms, Outcoming, to_own_home_regions
  @tc.add_one_service_category_tarif_class(_sctcg_own_home_regions_sms_to_own_home_regions, {}, 
    {:calculation_order => 0,:standard_formula_id => _stf_price_by_count_volume_item, :price => 0.5000000000})
...
#Own country, Calls, incoming
  @tc.add_one_service_category_tarif_class(_sctcg_own_country_calls_incoming.merge({:tarif_option_id => _mts_everywhere_as_home_smart, :tarif_option_order => 0}), {}, 
    {:calculation_order => 0,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 0.0},
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
