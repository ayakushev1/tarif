...
@tc = ServiceHelper::TarifCreator.new(_mts)
  @tc.create_tarif_class('Smart mini')
#Добавление новых service_category_group
  ...
  scg_mts_smart_mini_included_in_tarif_internet = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_sum_volume_m_byte, :formula => {:window_condition => "(500.0 >= sum_volume)"}, :price => 0.0, :description => '' }
    )
...
#Own region, sms, Outcoming, to_local_number
  @tc.add_one_service_category_tarif_class(_sctcg_own_region_sms_local, {}, 
    {:calculation_order => 0,:standard_formula_id => _stf_price_by_count_volume_item, :price => 2.0000000000})
...
#Own region, Internet
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_region_internet, scg_mts_smart_mini_included_in_tarif_internet[:id])
