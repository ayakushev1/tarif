...
#Intranet rouming, mms, outcoming, to own and home regions, to all operators
  category = { :name => '_sctcg_own_home_regions_mms_to_own_country_own_operator', :service_category_rouming_id => _intra_net_rouming, :service_category_calls_id => _mms_out, :service_category_geo_id => _service_to_own_and_home_regions}
  @tc.add_grouped_service_category_tarif_class(category, scg_mts_umnyi_dom_included_in_tarif_mms[:id])
  @tc.add_one_service_category_tarif_class(category, {}, {:calculation_order => 1, :standard_formula_id => _stf_price_by_count_volume_item, :price => 6.5})
...
#All_russia_rouming, mms, outcoming, to_own_country
  category = {:name => '_sctcg_own_home_regions_sms_incoming', :service_category_rouming_id => _all_russia_rouming, :service_category_geo_id => _service_to_own_country, :service_category_calls_id => _mms_out}
