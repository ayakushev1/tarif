...
#Intranet rouming, mms, outcoming, to all own country regions, to own operator
  @tc.add_one_service_category_tarif_class(_sctcg__all_russia_rouming_mms_to_own_country_own_operator, {}, {:standard_formula_id => _stf_price_by_count_volume_item, :price => 3.25},
    :tarif_set_must_include_tarif_options => [_mts_mms_discount_50_percent] )
