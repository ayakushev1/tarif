...
@tc.create_tarif_class({
  :id => _mts_smart_top, :name => 'Smart Top', :operator_id => _mts, :privacy_id => _person, :standard_service_id => _tarif,  
...
#Добавление новых service_category_group
  ...
  scg_mts_smart_top_included_in_tarif_calls = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_price_by_sum_duration_minute, 
      :formula => {:window_condition => "(2000.0 >= sum_duration_minute)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
  ...
  scg_mts_smart_top_included_in_tarif_sms = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_count_volume_item, 
      :formula => {:window_condition => "(2000.0 >= count_volume)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => _stf_price_by_1_month, :price => 1400.0})
...
#Own and home regions, Calls, Outcoming, to_own_and_home_region, to_own_operator
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_home_regions_calls_to_own_home_regions_own_operator, scg_mts_smart_top_included_in_tarif_calls[:id])
...
#Own and home regions, Calls, Outcoming, to_own_and_home_region, to_not_own_operator
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_home_regions_calls_to_own_home_regions_not_own_operator, scg_mts_smart_top_included_in_tarif_calls[:id])
...
#Own and home regions, sms, Outcoming, to_own_home_regions
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_home_regions_sms_to_own_home_regions, scg_mts_smart_top_included_in_tarif_sms[:id])
...
#Own and home regions, sms, Outcoming, to_not_own_country
  @tc.add_one_service_category_tarif_class(_sctcg_own_home_regions_sms_to_not_own_country, {}, 
    {:calculation_order => 0,:standard_formula_id => _stf_price_by_count_volume_item, :price => 5.25})

#Own and home regions, Internet
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_home_regions_internet, scg_mts_smart_top_included_in_tarif_internet[:id])
...
#Own country, Calls, Outcoming, to_own_home_regions, to_own_operator
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_country_calls_to_own_country_own_operator.merge({:tarif_option_id => _mts_everywhere_as_home_smart, :tarif_option_order => 0}), 
    scg_mts_smart_top_included_in_tarif_calls[:id],
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
...
#Own country, Calls, Outcoming, to_own_country, to_own_operator
  ...
  @tc.add_one_service_category_tarif_class(_sctcg_own_country_calls_to_own_country_own_operator.merge({:tarif_option_id => _mts_everywhere_as_home_smart, :tarif_option_order => 0}),   {},
    {:calculation_order => 1,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 5.0},
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )

#Own country, Calls, Outcoming, to_own_country, to_other_operator
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_country_calls_to_own_country_not_own_operator.merge({:tarif_option_id => _mts_everywhere_as_home_smart, :tarif_option_order => 0}), 
    scg_mts_smart_top_included_in_tarif_calls[:id],
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
  @tc.add_one_service_category_tarif_class(_sctcg_own_country_calls_to_own_country_not_own_operator.merge({:tarif_option_id => _mts_everywhere_as_home_smart, :tarif_option_order => 0}),   {},
    {:calculation_order => 1,:standard_formula_id => _stf_price_by_sum_duration_minute, :price => 14.0},
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
...
#Own country, Internet
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_country_internet.merge({:tarif_option_id => _mts_everywhere_as_home_smart, :tarif_option_order => 0}), 
    scg_mts_smart_top_included_in_tarif_internet[:id],
    :tarif_set_must_include_tarif_options => [_mts_everywhere_as_home_smart] )
