...
_sctcg_own_country_sms_to_own_country = {:name => '_sctcg_own_country_sms_to_own_country', :service_category_rouming_id => _own_country_rouming, :service_category_calls_id => _sms_out, :service_category_geo_id => _service_to_own_country}
...
#Ежемесячная плата
  @tc.add_one_service_category_tarif_class(_sctcg_periodic_monthly_fee, {}, {:standard_formula_id => _stf_price_by_1_month, :price => 2500.0})
...
#Own and home regions, Calls, Outcoming, to_own_and_home_region, to_not_own_operator
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_home_regions_calls_to_own_home_regions_not_own_operator, scg_mts_ultra_included_in_tarif_calls[:id])
...
#Own and home regions, sms, Outcoming, to_own_home_regions
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_home_regions_sms_to_own_home_regions, scg_mts_ultra_included_in_tarif_sms[:id])
...
#Own and home regions, sms, Outcoming, to_own_country
  ...
  @tc.add_one_service_category_tarif_class(_sctcg_own_home_regions_sms_to_own_country, {}, 
    {:calculation_order => 1,:standard_formula_id => _stf_price_by_count_volume_item, :price => 3.8000000000})
...
#Own and home regions, sms, Outcoming, to_not_own_country
  @tc.add_one_service_category_tarif_class(_sctcg_own_home_regions_sms_to_not_own_country, {}, 
    {:calculation_order => 0,:standard_formula_id => _stf_price_by_count_volume_item, :price => 3.9500000000})

#Own and home regions, Internet
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_home_regions_internet, scg_mts_ultra_included_in_tarif_internet[:id])
...
#Own country, sms, outcoming, to own country
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_country_sms_to_own_country, scg_mts_ultra_included_in_tarif_sms[:id])

#Own country, Internet
  @tc.add_grouped_service_category_tarif_class(_sctcg_own_country_internet, scg_mts_ultra_included_in_tarif_internet[:id])
