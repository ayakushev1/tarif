...
#Добавление новых service_category_group
  ...
  scg_mts_smart_plus_included_in_tarif_calls = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_price_by_sum_duration_minute, 
      :formula => {:window_condition => "(1100.0 >= sum_duration_minute)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
  ...
  scg_mts_smart_plus_included_in_tarif_sms = @tc.add_service_category_group(
    ...
    {:calculation_order => 0, :standard_formula_id => _stf_zero_count_volume_item, 
      :formula => {:window_condition => "(1100.0 >= count_volume)", :window_over => 'month'}, :price => 0.0, :description => '' }
    )
  ...
  scg_mts_add_speed_100mb = @tc.add_service_category_group(
    ...
    {:calculation_order => 1, :price => 30.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_100mb_mts_smart_plus', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'day',
         :stat_params => {
  ...
  scg_mts_add_speed_500mb = @tc.add_service_category_group(
    ...
    {:calculation_order => 2, :price => 95.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_500mb_mts_smart_plus', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
  ...
  scg_mts_add_speed_2gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 3, :price => 250.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_2gb_mts_smart_plus', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
  ...
  scg_mts_add_speed_5gb = @tc.add_service_category_group(
    ...
    {:calculation_order => 4, :price => 450.0, :price_unit_id => _rur, :volume_id => _call_description_volume, :volume_unit_id => _m_byte, :name => 'scf_mts_add_speed_5gb_mts_smart_plus', :description => '', 
     :formula => {
       :auto_turbo_buttons  => {
         :group_by => 'month',
         :stat_params => {
