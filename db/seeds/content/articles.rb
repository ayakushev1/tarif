...
Content::Article.create(id: 1, author_id: 0, type_id: _cntt_demo_results, status_id: _cnts_published,
  ...
  content: {
    ...
    summary: "Если модель использования мобильной связи совпадает с вашей, то предпочтительным вариантом является тариф Билайна, Совсем все, плюс тарифную 
              опцию, Самый выгодный интернет в роуминге",
    body: "Основной причиной такой рекомендации является то, что выбирая такой тариф и опции вы сможете получить экономию порядка полторы тысяч рублей",
  },
  key: {
...
Content::Article.create(id: 3, author_id: 0, type_id: _cntt_demo_results, status_id: _cnts_published,
  ...
  content: {
    ...
    summary: "Если модель использования мобильной связи совпадает с вашей, то предпочтительным вариантом является тариф Билайна, Совсем все, плюс тарифные 
