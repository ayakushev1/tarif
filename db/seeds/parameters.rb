...
pars = []
pars << { :id => 0, :source_type_id => _call_data, :nick_name => 'base_service', :name => 'base service', :description => '', 
...
pars << { :id => 1, :source_type_id => _call_data, :nick_name => 'base_sub_service', :name => 'base subservice', :description => '', 
...
pars << { :id => 2, :source_type_id => _call_data, :nick_name => 'own_phone_number', :name => 'own phone number', :description => '', 
...
pars << { :id => 3, :source_type_id => _call_data, :nick_name => 'own_phone_operator_id', :name => 'own phone operator_id', :description => '', 
...
pars << { :id => 4, :source_type_id => _call_data, :nick_name => 'own_phone_region_id', :name => 'own phone region_id', :description => '', 
...
pars << { :id => 5, :source_type_id => _call_data, :nick_name => 'own_phone_country_id', :name => 'own phone country_id', :description => '', 
...
pars << { :id => 6, :source_type_id => _call_data, :nick_name => 'partner_phone_number', :name => 'partner phone number', :description => '', 
...
pars << { :id => 7, :source_type_id => _call_data, :nick_name => 'partner_phone_operator_id', :name => 'partner phone operator_id', :description => '', 
...
pars << { :id => 8, :source_type_id => _call_data, :nick_name => 'partner_phone_operator_type_id', :name => 'partner phone operator_type_id', :description => '', 
...
pars << { :id => 9, :source_type_id => _call_data, :nick_name => 'partner_phone_region_id', :name => 'partner phone region_id', :description => '', 
...
pars << { :id => 10, :source_type_id => _call_data, :nick_name => 'partner_phone_country_id', :name => 'partner phone country_id', :description => '', 
...
pars << { :id => 11, :source_type_id => _call_data, :nick_name => 'connect_operator_id', :name => 'connect operator_id', :description => '', 
...
pars << { :id => 12, :source_type_id => _call_data, :nick_name => 'connect_region_id', :name => 'connect region_id', :description => '', 
...
pars << { :id => 13, :source_type_id => _call_data, :nick_name => 'connect_country_id', :name => 'connect country', :description => '', 
...
pars << { :id => 14, :source_type_id => _call_data, :nick_name => 'description_time', :name => 'description time', :description => '', 
...
pars << { :id => 15, :source_type_id => _call_data, :nick_name => 'description_duration', :name => 'description duration', :description => '', 
...
pars << { :id => 16, :source_type_id => _call_data, :nick_name => 'description_volume', :name => 'description volume', :description => '', 
...
pars << { :id => 49, :source_type_id => _intermediate_data, :nick_name => 'category_operator_type_id', :name => 'category_operator_type_id', :description => '', 
...
pars << { :id => 100, :source_type_id => _input_data, :nick_name => '@fq_tarif_operator_id', :name => '@fq_tarif_operator_id', :description => '', 
          :source => {:input => 'variable', :field => '@fq_tarif_operator_id', :sub_field => '', :field_type_id => _integer, :sub_field_type_id => nil},          
          :display => {:display_type_id => _value, :list => '', :table => '', :string => '', :query => '', :class => '',:id_field => '', :name_field => ''},
          :unit => {:unit_id => nil, :field_name => '', :sub_field_name => ''} }

pars << { :id => 101, :source_type_id => _input_data, :nick_name => '@fq_tarif_region_id', :name => '@fq_tarif_region_id', :description => '', 
          :source => {:input => 'variable', :field => '@fq_tarif_region_id', :sub_field => '', :field_type_id => _integer, :sub_field_type_id => nil},          
          :display => {:display_type_id => _value, :list => '', :table => '', :string => '', :query => '', :class => '',:id_field => '', :name_field => ''},
          :unit => {:unit_id => nil, :field_name => '', :sub_field_name => ''} }

pars << { :id => 102, :source_type_id => _intermediate_data, :nick_name => 'fq_tarif_home_region_ids', :name => 'fq_tarif_home_region_ids', :description => '', 
...
pars << { :id => 103, :source_type_id => _intermediate_data, :nick_name => 'fq_tarif_country_id', :name => 'fq_tarif_country_id', :description => '', 
