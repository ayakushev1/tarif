...
p = {}; c = {};
p[:p_rouming_region_own_operator] = {:operator_id => own_operator_id, :region_id => rouming_region_id, :country_id =>  own_country_id, :operator_type_id => _mobile, :number => p_phone}
